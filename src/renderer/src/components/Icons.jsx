...
import visaSrc from '../assets/visa-card.svg'
import masterCardSrc from '../assets/master-card.svg'
import applePaySrc from '../assets/apple-pay.svg'
import googlePaySrc from '../assets/google-pay.svg'
import paypalSrc from '../assets/paypal.svg'
...
export const CardIcon = ({ className }) => (
  ...
  >
    <img src={visaSrc} alt="Visa" style={{ height: '100%', width: 'auto' }} />
    <img src={masterCardSrc} alt="MasterCard" style={{ height: '100%', width: 'auto' }} />
  </div>
)
...
export const WalletIcon = ({ className }) => (
  <div
    ...
    style={{ display: 'flex', alignItems: 'center', gap: '6px', width: 'auto' }}
  >
    <img src={applePaySrc} alt="Apple Pay" style={{ height: '100%', width: 'auto' }} />
    <img src={googlePaySrc} alt="Google Pay" style={{ height: '100%', width: 'auto' }} />
  </div>
)

export const PayPalIcon = ({ className }) => (
  <img src={paypalSrc} className={className} alt="PayPal" />
)